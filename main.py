...
target_model = 'gemini-2.5-flash'  # ✅ 모델 변경: gemini-3.5-flash → gemini-2.5-flash
...
# ==========================================
tickers = [
    'AAPL', 'MSFT', 'NVDA', 'TSM', 'ALB', 'XOM', 'SLB', 'CELH', 'BBW', 'SMR',
    'ASML', 'HSY', 'RCL', 'GOOG', 'WM', 'VRT', 'CRDO', 'META', 'TSLA', 'LITE', 'BE',
    '035420.KS', '021240.KS', '033780.KS', '213420.KS', '034220.KS', '059090.KS',
    '338220.KS', 'BA', 'FUTU', 'ELV', '373220.KS', 'SPCE', '047050.KS'
]
...
def _ddg_search(kw, timelimit, max_results=10):
    ...
    for attempt in range(3):
        try:
            with DDGS() as ddgs:
                # ✅ 수정: keywords=kw → 위치 인수(kw)로 변경 (ddgs v6+ API 변경 대응)
                results = ddgs.news(kw, timelimit=timelimit, max_results=max_results) or []
